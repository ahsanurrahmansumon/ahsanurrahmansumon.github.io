...
document.addEventListener('DOMContentLoaded', function() {
  const texts = ["Software Developer.", "Web Developer.", "Font-end Developer."];
  let index = 0;
  let charIndex = 0;
  const speed = 150; // Adjust typing speed here
  const delayBetweenLines = 1000; // Delay between lines
  const delayAfterTyping = 2000; // Delay after typing before backspacing
  ...
  function type() {
    if (charIndex < texts[index].length) {
      ...
      setTimeout(backspace, delayAfterTyping);
    }
  }
